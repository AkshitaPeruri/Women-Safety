...
text.insert(END,"Polarity Score
      : "+str(blob.polarity)+"\n") 
text.insert(END,'======================================================
 ==============================\n') 
...
: 
'+str(pos/len(clean_list))+'%\n') 
text.insert(END,'Negative 
'+str(neg/len(clean_list))+'%\n') 
text.insert(END,'Neutral  
'+str(neu/len(clean_list))+'%\n') 
...
= 
= 
title = Label(main, text='Analysis of Women Safety in Indian Cities Using Machine Learning 
on Tweets') 
